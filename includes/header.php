...
<head>
    ...
    <script src="<?= BASE_URL_SLASH ?>assets/js/tailwind.min.js"></script>
    <link rel="stylesheet" href="<?= BASE_URL_SLASH ?>assets/css/inter.css">
    <link rel="stylesheet" href="<?= BASE_URL_SLASH ?>assets/css/all.min.css">
    <link rel="stylesheet" href="<?= BASE_URL_SLASH ?>assets/css/style.css">
</head>
<body>
<!-- Doodle Background -->
<div class="doodle-bg">
